...
public class TwinValueRangeCursorFactory
{
	 ...
	 * 
	 * @param <T> The type of the images to work on. Needs to be a ComparableType.
	 ...
	 */	
	public static < T extends ComparableType< T > > TwinValueRangeCursor<T> generateAlwaysTrueCursor(Image<T> img1, Image<T> img2) {
	 ...
	 */
	public static < T extends ComparableType< T > > TwinValueRangeCursor<T> generateAboveThresholdCursor(Image<T> img1, Image<T> img2,
	 ...
	 */
	public static < T extends ComparableType< T > > TwinValueRangeCursor<T> generateBelowThresholdCursor(Image<T> img1, Image<T> img2,
			T threshold1, T threshold2) {
